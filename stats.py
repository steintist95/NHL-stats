...
if conn.is_connected():
    ...
    #             'INSERT INTO `GOALIES` '
    #             'VALUES (%s,"%s","%s",%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
    #             ) % (goalie_number, goalie_name, team, games_played_in, games_started, minutes,
    #             goals_against_average, wins, losses, overtime_losses, shutouts, shots_against,
    #             goals_against, save_percentage, goalie_goals, goalie_assists,goalie_penalty_minutes)
    #         try:
    #             logging.info("\tINSERTING {}'S GOALIE STATS INTO GOALIE TABLE".format(goalie_name.upper()))
    #             cursor.execute(add_goalie_stats, data_goalie)
    #         except mysql.connector.IntegrityError as err:
    ...
    for item in urls_skater1_goalie2:
        ...
        for row in soup('table')[0].findAll('tr')[1:]:
            ...
            add_skater_stats = (
                ...
                plus_minus, penalty_minutes, power_play_goals, short_handed_goals,game_winning_goals, shots, shot_percentage)
